...
// #include "../Stacks & Queues/queue_array.h"
...
private:
    ...
    // void max_value_helper(Node<K, V> *, Map<V, V> &);
    void max_value_helper(Node<K, V> *, V &);
    Node<K, V> *getMax() const;
    Node<K, V> *getMin() const;
...
// {
//     Map<K, V> result;
//     trim(lo, hi, root, result);
//     if (this == &result)
//         return;

//     clear(root);
//     root = copy_from(result.root);
// }

// template <class K, class V>
// void Map<K, V>::trim(const K &lo, const K &hi, Node<K, V> *curr, Map<K, V> &result)
// {
//     if (curr == nullptr)
//         return;

//     if (curr->key >= lo && curr->key <= hi)
//         result.insert(curr->key, curr->value);
//     trim(lo, hi, curr->left, result);
//     trim(lo, hi, curr->right, result);
// }
...
//     Map<V, V> TreeOfVal;
//     Node<K, V> *curr = root;
//     max_value_helper(curr, TreeOfVal);
//     Node<V, V> *curr1 = TreeOfVal.get_root();
...
// template <class K, class V>
// void Map<K, V>::max_value_helper(Node<K, V> *curr, Map<V, V> &Tree)
// {
//     if (curr == nullptr)
//         return;

//     max_value_helper(curr->left, Tree);
//     Tree.insert(curr->value, curr->value);
